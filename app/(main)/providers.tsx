    ...
    console.error = (...args) => {
      ...
      if (
        ...
        (messageString.includes(
          ...
          (messageString.includes('React.createElement: type is invalid') &&
            args[1]?.includes('<think>')) ||
        ...
        console.log(
          'Suppressor Check: Matched and suppressing known error:',
          messageString
        );
      ...
      console.log(
        'Suppressor Check: Did not match, passing error through:',
        args
      );
